...
CATEGORIES = {
    "노트북": {
        ...
        # Vane 답변이 국내 소비자 관용 표기(그램, 맥북) 대신 영문 국제 브랜드명
        # (Lenovo, Apple, ASUS 등)으로 나오는 경우가 실측으로 확인돼 영문 별칭도 등록.
        "aliases": {
            "LG전자": ["LG 그램", "그램", "LG", "LG Gram"],
            "삼성전자": ["갤럭시북", "삼성", "Samsung", "Galaxy Book"],
            "애플": ["맥북", "맥북에어", "맥북프로", "Apple", "MacBook", "MacBook Air", "MacBook Pro"],
            "레노버": ["Lenovo", "ThinkPad"],
            "에이수스": ["ASUS", "Zenbook"],
        },
        "queries": [
    ...
    "청소기": {
        ...
        "aliases": {
            "삼성전자": ["비스포크 제트", "Samsung", "Bespoke Jet"],
            "LG전자": ["코드제로", "LG 코드제로", "LG", "CordZero"],
            "다이슨": ["Dyson"],
            "샤크": ["Shark"],
            "일렉트로룩스": ["Electrolux"],
        },
