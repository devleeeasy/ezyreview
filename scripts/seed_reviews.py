...
async def seed():
    ...
    for i in range(50):
        reviews.append(Review(
            order_id=f"seed-order-pos-{i+1:03d}",
    ...
    for i in range(30):
        reviews.append(Review(
            order_id=f"seed-order-neg-{i+1:03d}",
    ...
    for i in range(20):
        reviews.append(Review(
            order_id=f"seed-order-neu-{i+1:03d}",
    ...
    print(f"Inserted {len(reviews)} reviews (50 positive / 30 negative / 20 neutral)")
